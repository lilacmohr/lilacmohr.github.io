...
*Part three of a three-part series. Part one: [Cognitive Drain: The Silent Risk of AI-Assisted Development](/articles/cognitive-drain-problem.html). Part two: [What Just Happened? Capturing Engineering Decisions in the Age of AI](/articles/what-just-happened.html).*
...
- Define the three decision levels with your Staff engineers (introduced in [Part two](/articles/what-just-happened.html)) and agree on what requires a formal record versus what lives in the PR. Clarity here is what makes the practice sustainable.
...
**Staff+ engineers:**
- Identify the Level 1 contracts in your domain (the highest-impact service boundaries and architectural decisions, as defined in [Part two](/articles/what-just-happened.html)). If they don't have records, write them first - that's the immediate gap to close.
