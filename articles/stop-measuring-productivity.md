# Stop Measuring Productivity. Start Building the Conditions for It.

*Adapted from my conversation with Shane Hastie on the [InfoQ Engineering Culture Podcast](https://www.infoq.com/podcasts/engineering-success-key/) (July 2022).*
...
![When things are already broken: a four-step sequence for rebuilding trust](images/when-things-are-broken.png)
...
![Trust doesn't respond to information volume. It responds to consistency over time. You can't speed-run it.](images/trust-quote.png)
...
![The Three-Level Engineering Metrics Framework: Fundamentals, Collaboration, and Delivery](images/three-levels-of-metrics.png)
